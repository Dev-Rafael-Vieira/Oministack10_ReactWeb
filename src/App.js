          ...
          <div className="input-group">
            ...
            <div className="input-block" >
              ...
              <input 
                ...
                required 
                value={latitude}
                onChange={e => setLatitude(e.target.value)} //seta o valor do input dentro do valor latitude
              />
            </div>
            ...
            <div className="input-block" >
              ...
              <input 
               ...
               required 
               value={longitude}
               onChange={e => setLongitude(e.target.value)} //seta o valor do input dentro do valor longitude
              />
            </div>
